...
int main()
{
    ...
    Peca p1 = Peca("1578", "Parafuso", 7, 6.50);
    Peca p2 = Peca("2378", "Porca", 7, 2.00);
    Peca p3 = Peca("7576", "Prego", 15, 0.50);
    Peca p4 = Peca("6972", "Arruela", 15, 0.75);
    Peca p5 = Peca("1473", "Bucha", 7, 2.50);
    Peca p6 = Peca("9274", "Broca", 1, 19.50);
	n1.addPeca(p1);
	n1.addPeca(p2);
	n1.addPeca(p3);
	n1.addPeca(p4);
